                ...
                >
                    ...
                    {!user?.isPremium && (
                      <div className="grid md:grid-cols-2 gap-4 mb-6">
                        ...
                        <Card className="border-2 border-sky-primary bg-sky-primary/5">
                          ...
                          <p className="text-3xl font-black mb-4">
                            29,000₫<span className="text-sm font-normal text-gray-500">/month</span>
                          </p>
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              <Check className="w-4 h-4 text-green-500" />
                  ...
                  {user?.isPremium && (
                    <Card>
                      ...
                      <div className="space-y-1">
                        {[
                          { date: 'Dec 1, 2024', amount: '29,000₫', status: 'Paid' },
                          { date: 'Nov 1, 2024', amount: '29,000₫', status: 'Paid' },
                          { date: 'Oct 1, 2024', amount: '29,000₫', status: 'Paid' },
                        ].map((invoice, idx) => (
                          <div
                            key={idx}
