...
async function main() {
  ...
  const locations = await Promise.all([
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // EXPANDED SEED DATA - Additional locations for search & smart adjustment testing
    // ═══════════════════════════════════════════════════════════════════════════

    // MORE HIDDEN GEM RESTAURANTS
    prisma.location.create({
      data: {
        name: 'Quan Com Ba Buoi',
        nameLocal: 'Quán Cơm Bà Buổi',
        description: 'Family-run rice shop serving home-style Vietnamese comfort food. Local workers line up here daily for generous portions at unbeatable prices.',
        descriptionShort: 'Authentic home-style rice dishes',
        latitude: 16.0612,
        longitude: 108.2145,
        address: '156 Hoang Dieu, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['local', 'budget', 'authentic', 'lunch', 'hidden_gem', 'rice', 'vietnamese'],
        ...
        isHiddenGem: true,
        isAnvaVerified: true,
        openingHours: { mon: '10:00-14:00', tue: '10:00-14:00', wed: '10:00-14:00', thu: '10:00-14:00', fri: '10:00-14:00', sat: '10:00-14:00', sun: 'closed' },
      },
    }),
    prisma.location.create({
      data: {
        name: 'Bun Cha 109',
        nameLocal: 'Bún Chả 109',
        description: 'No-frills bun cha specialist where locals queue for the best Hanoi-style grilled pork and noodles in Da Nang.',
        descriptionShort: 'Best bun cha in Da Nang',
        latitude: 16.0589,
        longitude: 108.2201,
        address: '109 Nguyen Van Linh, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['local', 'budget', 'authentic', 'lunch', 'hidden_gem', 'noodles', 'pork'],
        imageUrl: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.7,
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Hải Sản Phước Mỹ',
        description: 'Beachside seafood market where you pick your catch and they cook it to order. Locals\' favorite for fresh, affordable seafood.',
        descriptionShort: 'Pick-your-own fresh seafood',
        latitude: 16.0567,
        longitude: 108.2489,
        address: 'Vo Nguyen Giap, Phuoc My, Son Tra, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['seafood', 'local', 'budget', 'fresh', 'beach', 'dinner', 'family_friendly'],
        imageUrl: 'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.5,
    ...
    prisma.location.create({
      data: {
        name: 'Vegetarian An Lac',
        nameLocal: 'Chay An Lạc',
        description: 'Buddhist vegetarian restaurant serving creative meat-free Vietnamese cuisine. Peaceful garden setting near a local pagoda.',
        descriptionShort: 'Peaceful Buddhist vegetarian restaurant',
        latitude: 16.0678,
        longitude: 108.2134,
        address: '45 Phan Chu Trinh, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['vegetarian', 'vegan', 'buddhist', 'healthy', 'peaceful', 'garden', 'lunch'],
        imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.4,
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'The Grill House',
        description: 'Premium steakhouse with imported Australian beef. Popular for business dinners and special occasions.',
        descriptionShort: 'Premium imported steaks',
        latitude: 16.0534,
        longitude: 108.2378,
        address: '88 Vo Van Kiet, Son Tra, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['steakhouse', 'western', 'luxury', 'dinner', 'business', 'premium', 'wine'],
        imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800',
        images: [],
        priceLevel: 4,
        rating: 4.6,
    ...
    prisma.location.create({
      data: {
        name: 'Little Italy Da Nang',
        nameLocal: 'Little Italy',
        description: 'Authentic Italian cuisine with handmade pasta and wood-fired pizza. Run by an Italian expat chef.',
        descriptionShort: 'Authentic Italian by Italian chef',
        latitude: 16.0512,
        longitude: 108.2423,
        address: '15 An Thuong 4, My An, Ngu Hanh Son, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['italian', 'pizza', 'pasta', 'western', 'dinner', 'romantic', 'expat'],
    ...
    prisma.location.create({
      data: {
        name: 'Sushi Hokkaido',
        nameLocal: 'Sushi Hokkaido',
        description: 'Japanese restaurant with fresh sushi and sashimi flown in from Japan. Omakase dining available.',
        descriptionShort: 'Premium Japanese sushi',
        latitude: 16.0489,
        longitude: 108.2401,
        address: '92 Nguyen Van Thoai, Son Tra, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['japanese', 'sushi', 'sashimi', 'premium', 'dinner', 'omakase', 'fresh'],
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Nhà Hàng BBQ Hàn Quốc',
        description: 'All-you-can-eat Korean BBQ with premium cuts. Popular with families and groups for interactive dining.',
        descriptionShort: 'All-you-can-eat Korean BBQ',
        latitude: 16.0601,
        longitude: 108.2267,
        address: '67 Le Duan, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'restaurant',
        tags: ['korean', 'bbq', 'buffet', 'dinner', 'family_friendly', 'group', 'interactive'],
        imageUrl: 'https://images.unsplash.com/photo-1590330297626-d7aff25a0431?w=800',
        images: [],
        priceLevel: 3,
        rating: 4.4,
        reviewCount: 678,
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Cafe Vườn Trên Mái',
        description: 'Hidden rooftop cafe with lush garden setting. Serves Vietnamese coffee and homemade cakes with city views.',
        descriptionShort: 'Secret rooftop garden cafe',
        latitude: 16.0645,
        longitude: 108.2178,
        address: '234 Nguyen Chi Thanh, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'cafe',
        tags: ['rooftop', 'garden', 'coffee', 'hidden_gem', 'instagram', 'cakes', 'views'],
        imageUrl: 'https://images.unsplash.com/photo-1445116572660-236099ec97a0?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.6,
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'The Workshop Coffee',
        description: 'Third-wave coffee shop with single-origin Vietnamese beans. Popular with digital nomads for fast wifi and good workspace.',
        descriptionShort: 'Digital nomad favorite coffee shop',
        latitude: 16.0523,
        longitude: 108.2312,
        address: '58 Bach Dang, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'cafe',
        tags: ['coffee', 'wifi', 'workspace', 'digital_nomad', 'specialty', 'laptop_friendly'],
    ...
    prisma.location.create({
      data: {
        name: 'Cong Ca Phe Son Tra',
        nameLocal: 'Cộng Cà Phê Sơn Trà',
        description: 'Communist-themed Vietnamese coffee chain. Famous for coconut coffee and retro military decor.',
        descriptionShort: 'Iconic communist-themed coffee',
        latitude: 16.0567,
        longitude: 108.2434,
        address: '96 Vo Nguyen Giap, Son Tra, Da Nang',
        city: 'Danang',
        category: 'cafe',
        tags: ['coffee', 'vietnamese', 'instagram', 'coconut_coffee', 'unique', 'chain'],
        imageUrl: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.3,
    ...
    prisma.location.create({
      data: {
        name: 'Hideaway Bookstore Cafe',
        nameLocal: 'Cafe Sách Ẩn Mình',
        description: 'Cozy bookstore cafe with floor-to-ceiling books. Quiet atmosphere perfect for reading and reflection.',
        descriptionShort: 'Peaceful bookstore cafe',
        latitude: 16.0634,
        longitude: 108.2189,
        address: '12 Tran Quoc Toan, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'cafe',
        tags: ['books', 'quiet', 'coffee', 'reading', 'peaceful', 'hidden_gem', 'cozy'],
    ...
    prisma.location.create({
      data: {
        name: 'Sunrise Beach Cafe',
        nameLocal: 'Cafe Bình Minh Biển',
        description: 'Early morning beach cafe serving strong Vietnamese coffee. Perfect spot to watch the sunrise over the ocean.',
        descriptionShort: 'Beach cafe for sunrise watching',
        latitude: 16.0545,
        longitude: 108.2489,
        address: 'My Khe Beach, Son Tra, Da Nang',
        city: 'Danang',
        category: 'cafe',
        tags: ['beach', 'sunrise', 'coffee', 'morning', 'ocean_view', 'photography', 'early'],
        imageUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.5,
        reviewCount: 456,
        avgDurationMins: 60,
        openingHours: { mon: '05:00-10:00', tue: '05:00-10:00', wed: '05:00-10:00', thu: '05:00-10:00', fri: '05:00-10:00', sat: '05:00-10:00', sun: '05:00-10:00' },
        isAnvaVerified: true,
      },
    }),
    ...
    prisma.location.create({
      data: {
        name: 'Da Nang Parasailing',
        nameLocal: 'Dù Lượn Đà Nẵng',
        description: 'Thrilling parasailing experience over My Khe Beach. See the coastline from 100 meters up!',
        descriptionShort: 'Beachside parasailing adventure',
        latitude: 16.0512,
        longitude: 108.2478,
        address: 'My Khe Beach, Son Tra, Da Nang',
        city: 'Danang',
        category: 'activity',
        tags: ['adventure', 'water_sports', 'thrill', 'beach', 'photography', 'extreme'],
        imageUrl: 'https://images.unsplash.com/photo-1503220317266-28ac8fc9c4a8?w=800',
        images: [],
        priceLevel: 3,
        rating: 4.6,
        reviewCount: 234,
    ...
    prisma.location.create({
      data: {
        name: 'Marble Mountain Rock Climbing',
        nameLocal: 'Leo Núi Ngũ Hành Sơn',
        description: 'Guided rock climbing on the limestone cliffs of Marble Mountains. Various routes for beginners to advanced climbers.',
        descriptionShort: 'Rock climbing on Marble Mountains',
        latitude: 16.0045,
        longitude: 108.2634,
        address: 'Marble Mountains, Ngu Hanh Son, Da Nang',
        city: 'Danang',
        category: 'activity',
        tags: ['adventure', 'rock_climbing', 'outdoor', 'challenging', 'nature', 'guided'],
    ...
    prisma.location.create({
      data: {
        name: 'Han River Stand Up Paddle',
        nameLocal: 'SUP Sông Hàn',
        description: 'Peaceful stand up paddleboarding on the Han River. Morning and sunset sessions available with city skyline views.',
        descriptionShort: 'SUP boarding on Han River',
        latitude: 16.0567,
        longitude: 108.2234,
        address: 'Bach Dang Riverfront, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'activity',
        tags: ['water_sports', 'sup', 'river', 'fitness', 'sunrise', 'sunset', 'scenic'],
        imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.5,
    ...
    prisma.location.create({
      data: {
        name: 'Son Tra Snorkeling Tour',
        nameLocal: 'Lặn Biển Sơn Trà',
        description: 'Snorkeling tour to the coral reefs around Son Tra Peninsula. See tropical fish and marine life.',
        descriptionShort: 'Coral reef snorkeling',
        latitude: 16.1123,
        longitude: 108.2789,
        address: 'Son Tra Peninsula, Son Tra, Da Nang',
        city: 'Danang',
        category: 'activity',
        tags: ['snorkeling', 'marine_life', 'nature', 'adventure', 'coral', 'ocean', 'guided'],
    ...
    prisma.location.create({
      data: {
        name: 'Countryside Cycling Tour',
        nameLocal: 'Tour Đạp Xe Nông Thôn',
        description: 'Half-day cycling tour through rice paddies, fishing villages, and local farms outside Da Nang.',
        descriptionShort: 'Cycle through rural Vietnam',
        latitude: 16.0234,
        longitude: 108.1567,
        address: 'Hoa Vang District, Da Nang',
        city: 'Danang',
        category: 'activity',
        tags: ['cycling', 'countryside', 'rural', 'nature', 'cultural', 'exercise', 'guided'],
        imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.8,
    ...
    prisma.location.create({
      data: {
        name: 'Escape Room Da Nang',
        nameLocal: 'Phòng Thoát Hiểm Đà Nẵng',
        description: 'Vietnam-themed escape rooms with puzzles based on local history and culture. Great for rainy days!',
        descriptionShort: 'Vietnamese-themed escape rooms',
        latitude: 16.0612,
        longitude: 108.2234,
        address: '78 Nguyen Van Linh, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'activity',
        tags: ['escape_room', 'indoor', 'group', 'rainy_day', 'fun', 'puzzles', 'teamwork'],
    ...
    prisma.location.create({
      data: {
        name: 'Bai But Secret Beach',
        nameLocal: 'Bãi Bụt',
        description: 'Secluded beach on Son Tra Peninsula accessible only by motorbike. Crystal clear water and no crowds.',
        descriptionShort: 'Secret secluded beach',
        latitude: 16.1234,
        longitude: 108.2901,
        address: 'Son Tra Peninsula, Son Tra, Da Nang',
        city: 'Danang',
        category: 'beach',
        tags: ['beach', 'secret', 'hidden_gem', 'swimming', 'secluded', 'nature', 'motorbike'],
        imageUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.7,
    ...
    prisma.location.create({
      data: {
        name: 'Tien Sa Beach',
        nameLocal: 'Bãi Biển Tiên Sa',
        description: 'Quiet beach near the port with calm waters. Popular with local families on weekends.',
        descriptionShort: 'Calm local beach near port',
        latitude: 16.1089,
        longitude: 108.2134,
        address: 'Tho Quang, Son Tra, Da Nang',
        city: 'Danang',
        category: 'beach',
        tags: ['beach', 'calm', 'local', 'family_friendly', 'swimming', 'weekend'],
    ...
    // MORE TEMPLES & CULTURAL SITES
    prisma.location.create({
      data: {
        name: 'Phap Lam Pagoda',
        nameLocal: 'Chùa Pháp Lâm',
        description: 'Active Buddhist pagoda with ornate architecture and peaceful gardens. Monks often welcome visitors.',
        descriptionShort: 'Active pagoda with monks',
        latitude: 16.0656,
        longitude: 108.2089,
        address: '574 Ong Ich Khiem, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'temple',
        tags: ['temple', 'buddhist', 'culture', 'peaceful', 'architecture', 'monks', 'spiritual'],
    ...
    prisma.location.create({
      data: {
        name: 'Tam Thai Pagoda',
        nameLocal: 'Chùa Tam Thai',
        description: 'Historic pagoda inside Marble Mountains with ancient Buddha statues and meditation caves.',
        descriptionShort: 'Historic cave pagoda',
        latitude: 16.0034,
        longitude: 108.2645,
        address: 'Inside Marble Mountains, Ngu Hanh Son, Da Nang',
        city: 'Danang',
        category: 'temple',
        tags: ['temple', 'cave', 'buddhist', 'historic', 'meditation', 'spiritual', 'mountains'],
    ...
    prisma.location.create({
      data: {
        name: 'Cao Dai Temple',
        nameLocal: 'Thánh Thất Cao Đài',
        description: 'Colorful temple of the Cao Dai religion, a unique Vietnamese faith blending Buddhism, Christianity, and Confucianism.',
        descriptionShort: 'Unique Cao Dai religious temple',
        latitude: 16.0789,
        longitude: 108.2045,
        address: '63 Hai Phong, Thanh Khe, Da Nang',
        city: 'Danang',
        category: 'temple',
        tags: ['temple', 'cao_dai', 'unique', 'colorful', 'culture', 'religion', 'architecture'],
        imageUrl: 'https://images.unsplash.com/photo-1576487503728-7c26a6f7e5d6?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.4,
        reviewCount: 234,
    ...
    prisma.location.create({
      data: {
        name: 'OQ Lounge',
        nameLocal: 'OQ Lounge',
        description: 'Upscale cocktail lounge with creative mixology and live acoustic music. Sophisticated evening spot.',
        descriptionShort: 'Upscale cocktail lounge',
        latitude: 16.0545,
        longitude: 108.2389,
        address: '23 An Thuong 1, My An, Ngu Hanh Son, Da Nang',
        city: 'Danang',
        category: 'nightlife',
        tags: ['cocktails', 'lounge', 'live_music', 'upscale', 'evening', 'romantic', 'sophisticated'],
    ...
    prisma.location.create({
      data: {
        name: 'Memory Lounge',
        nameLocal: 'Memory Lounge',
        description: 'Retro-themed lounge bar playing 80s and 90s hits. Popular with nostalgic travelers and expats.',
        descriptionShort: 'Retro 80s/90s themed bar',
        latitude: 16.0523,
        longitude: 108.2412,
        address: '45 An Thuong 2, My An, Ngu Hanh Son, Da Nang',
        city: 'Danang',
        category: 'nightlife',
        tags: ['bar', 'retro', 'music', 'expat', 'dancing', 'fun', 'nostalgic'],
        imageUrl: 'https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.4,
    ...
    prisma.location.create({
      data: {
        name: 'Barefoot Bar',
        nameLocal: 'Barefoot Bar',
        description: 'Beachside bar with sand floor, hammocks, and bonfire nights. Chill reggae vibes and cocktails.',
        descriptionShort: 'Chill beachside bar with hammocks',
        latitude: 16.0534,
        longitude: 108.2478,
        address: 'My Khe Beach, Son Tra, Da Nang',
        city: 'Danang',
        category: 'nightlife',
        tags: ['beach_bar', 'chill', 'hammocks', 'bonfire', 'cocktails', 'reggae', 'sunset'],
    ...
    prisma.location.create({
      data: {
        name: 'Cham Island Handicrafts',
        nameLocal: 'Đồ Thủ Công Cù Lao Chàm',
        description: 'Artisan workshop selling handmade crafts from Cham Island. Supports local island community.',
        descriptionShort: 'Authentic island handicrafts',
        latitude: 16.0612,
        longitude: 108.2178,
        address: '89 Tran Phu, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'shopping',
        tags: ['shopping', 'handicrafts', 'souvenirs', 'local', 'artisan', 'sustainable', 'gifts'],
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Vincom Plaza Đà Nẵng',
        description: 'Modern shopping mall with international brands, cinema, and food court. Good for rainy days.',
        descriptionShort: 'Modern shopping mall',
        latitude: 16.0589,
        longitude: 108.2234,
        ...
        city: 'Danang',
        category: 'shopping',
        tags: ['shopping', 'mall', 'brands', 'cinema', 'rainy_day', 'food_court', 'modern'],
        imageUrl: 'https://images.unsplash.com/photo-1519567241046-7f570ee2a15f?w=800',
        images: [],
        priceLevel: 3,
        rating: 4.2,
        reviewCount: 678,
    ...
    prisma.location.create({
      data: {
        name: 'Night Market Helio',
        nameLocal: 'Chợ Đêm Helio',
        description: 'Evening market with street food, local goods, and carnival games. Fun family atmosphere.',
        descriptionShort: 'Evening market with food and games',
        latitude: 16.0567,
        longitude: 108.2112,
        address: '2/9 Street, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'market',
        tags: ['market', 'night_market', 'street_food', 'shopping', 'family_friendly', 'evening', 'games'],
        ...
        avgDurationMins: 90,
        isPopular: true,
        openingHours: { mon: '17:00-22:00', tue: '17:00-22:00', wed: '17:00-22:00', thu: '17:00-22:00', fri: '17:00-23:00', sat: '17:00-23:00', sun: '17:00-22:00' },
      },
    }),
    ...
    prisma.location.create({
      data: {
        name: 'Fusion Maia Spa',
        nameLocal: 'Fusion Maia Spa',
        description: 'World-class resort spa with unlimited treatments included. Pool villas and beachfront setting.',
        descriptionShort: 'Luxury all-inclusive spa resort',
        latitude: 16.0123,
        longitude: 108.2678,
        address: 'Non Nuoc Beach, Ngu Hanh Son, Da Nang',
        city: 'Danang',
        category: 'wellness',
        tags: ['spa', 'luxury', 'resort', 'massage', 'beach', 'premium', 'all_inclusive'],
        imageUrl: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800',
        images: [],
        priceLevel: 5,
        rating: 4.9,
    ...
    prisma.location.create({
      data: {
        name: 'Traditional Blind Massage',
        nameLocal: 'Massage Người Khiếm Thị',
        description: 'Authentic Vietnamese massage by trained blind therapists. Supports local disability community.',
        descriptionShort: 'Authentic massage supporting community',
        latitude: 16.0623,
        longitude: 108.2189,
        address: '34 Phan Dinh Phung, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'wellness',
        tags: ['massage', 'authentic', 'traditional', 'budget', 'community', 'therapeutic'],
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Trung Tâm Thiền',
        description: 'Buddhist meditation center offering drop-in sessions and multi-day retreats. English instruction available.',
        descriptionShort: 'Buddhist meditation sessions',
        latitude: 16.0678,
        longitude: 108.2045,
        address: '156 Hai Phong, Thanh Khe, Da Nang',
        city: 'Danang',
        category: 'wellness',
        tags: ['meditation', 'buddhist', 'retreat', 'spiritual', 'peaceful', 'english', 'wellness'],
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Đèo Hải Vân',
        description: 'Legendary mountain pass with stunning coastal views. Famous from Top Gear Vietnam Special.',
        descriptionShort: 'Iconic mountain pass views',
        latitude: 16.2012,
        longitude: 108.1234,
        address: 'Hai Van Pass, between Da Nang and Hue',
        city: 'Danang',
        category: 'nature',
        tags: ['viewpoint', 'nature', 'photography', 'motorbike', 'iconic', 'mountains', 'coastal'],
        imageUrl: 'https://images.unsplash.com/photo-1528127269322-539801943592?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.9,
    ...
    prisma.location.create({
      data: {
        name: 'Lang Co Lagoon',
        nameLocal: 'Đầm Lăng Cô',
        description: 'Tranquil lagoon between Da Nang and Hue. Kayaking, fishing, and peaceful scenery.',
        descriptionShort: 'Peaceful lagoon for kayaking',
        latitude: 16.2456,
        longitude: 108.0678,
        address: 'Lang Co, Phu Loc, Thua Thien Hue',
        city: 'Danang',
        category: 'nature',
        tags: ['lagoon', 'kayaking', 'peaceful', 'fishing', 'nature', 'scenic', 'day_trip'],
    ...
    prisma.location.create({
      data: {
        name: 'Cu De River Bamboo Forest',
        nameLocal: 'Rừng Tre Sông Cu Đê',
        description: 'Beautiful bamboo forest along the Cu De River. Peaceful boat rides and cycling paths.',
        descriptionShort: 'Scenic bamboo forest by river',
        latitude: 16.1234,
        longitude: 108.0567,
        address: 'Hoa Bac, Hoa Vang, Da Nang',
        city: 'Danang',
        category: 'nature',
        tags: ['bamboo', 'forest', 'river', 'cycling', 'boat', 'peaceful', 'photography'],
    ...
    // MORE ATTRACTIONS & VIEWPOINTS
    prisma.location.create({
      data: {
        name: 'DHC Marina',
        nameLocal: 'Bến Du Thuyền DHC',
        description: 'Modern marina with luxury yachts and waterfront restaurants. Great for evening strolls.',
        descriptionShort: 'Luxury marina for evening strolls',
        latitude: 16.0567,
        longitude: 108.2234,
        address: 'Bach Dang, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'attraction',
        tags: ['marina', 'waterfront', 'evening', 'romantic', 'modern', 'photography', 'stroll'],
        imageUrl: 'https://images.unsplash.com/photo-1514649923863-ceaf75b7ec00?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.3,
        reviewCount: 456,
    ...
    prisma.location.create({
      data: {
        name: 'APEC Sculpture Garden',
        nameLocal: 'Vườn Tượng APEC',
        description: 'Waterfront park with sculptures from APEC 2017 summit nations. Beautiful at sunset.',
        descriptionShort: 'International sculpture garden',
        latitude: 16.0545,
        longitude: 108.2267,
        address: 'Tran Hung Dao, Son Tra, Da Nang',
        city: 'Danang',
        category: 'attraction',
        tags: ['park', 'sculptures', 'art', 'waterfront', 'sunset', 'free', 'photography'],
        imageUrl: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800',
        images: [],
        priceLevel: 1,
        rating: 4.2,
    ...
    prisma.location.create({
      data: {
        ...
        nameLocal: 'Vòng Quay Sun Wheel',
        description: 'One of the tallest Ferris wheels in Southeast Asia. Stunning night views of Da Nang.',
        descriptionShort: 'Giant Ferris wheel with city views',
        latitude: 16.0389,
        longitude: 108.2267,
        address: 'Asia Park, Hoa Cuong Bac, Hai Chau, Da Nang',
        city: 'Danang',
        category: 'attraction',
        tags: ['ferris_wheel', 'views', 'night', 'family_friendly', 'iconic', 'photography', 'romantic'],
        imageUrl: 'https://images.unsplash.com/photo-1518756131217-31eb79b20e8f?w=800',
        images: [],
        priceLevel: 2,
        rating: 4.4,
        reviewCount: 789,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ADDITIONAL ITINERARIES - More variety for search & testing
  // ═══════════════════════════════════════════════════════════════════════════

  // Day Trip Special - 1 Day
  const dayTripItinerary = await prisma.itinerary.create({
    data: {
      title: 'Perfect Danang Day Trip',
      description: 'Make the most of a single day in Da Nang with the essential highlights and local gems.',
      city: 'Danang',
      durationDays: 1,
      coverImage: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=800',
      isTemplate: true,
      ...
      items: {
        create: [
          { locationId: locations[0].id, dayNumber: 1, orderIndex: 0, startTime: '06:00', endTime: '07:30', transportMode: 'walk', notes: 'Sunrise at My Khe Beach' },
          { locationId: locations[31].id, dayNumber: 1, orderIndex: 1, startTime: '08:00', endTime: '09:00', transportMode: 'grab_bike', notes: 'Famous pho breakfast' },
          { locationId: locations[3].id, dayNumber: 1, orderIndex: 2, startTime: '09:30', endTime: '12:00', transportMode: 'grab_bike', notes: 'Marble Mountains exploration' },
          { locationId: locations[8].id, dayNumber: 1, orderIndex: 3, startTime: '12:30', endTime: '14:00', transportMode: 'grab_bike', notes: 'Seafood lunch' },
          { locationId: locations[16].id, dayNumber: 1, orderIndex: 4, startTime: '14:30', endTime: '16:00', transportMode: 'grab_bike', notes: 'Cham Museum' },
          { locationId: locations[12].id, dayNumber: 1, orderIndex: 5, startTime: '17:00', endTime: '19:00', transportMode: 'grab_bike', notes: 'Sky36 sunset drinks' },
          { locationId: locations[2].id, dayNumber: 1, orderIndex: 6, startTime: '21:00', endTime: '22:00', transportMode: 'grab_bike', notes: 'Dragon Bridge show (Sat/Sun)' },
        ],
      },
    },
  });
  ...
  await prisma.itineraryTemplate.create({
    data: {
      name: 'Perfect Danang Day Trip',
      description: 'Make the most of a single day in Da Nang with essential highlights.',
      coverImage: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=800',
      tagline: 'One day, endless memories',
      city: 'Danang',
      durationDays: 1,
      targetPersonas: ['time_limited', 'business'],
      targetVibes: ['efficient', 'highlights', 'essential'],
      targetBudget: 'moderate',
      targetInterests: ['sightseeing', 'culture', 'food', 'photography'],
      highlights: ['Sunrise beach', 'Marble Mountains', 'Dragon Bridge show'],
      badges: ['day_trip', 'efficient', 'popular'],
      itineraryId: dayTripItinerary.id,
      displayOrder: 12,
    },
  });

  // Wellness Retreat - 4 Days
  const wellnessRetreatItinerary = await prisma.itinerary.create({
    data: {
      title: 'Wellness & Rejuvenation Retreat',
      description: 'A healing journey focused on spa treatments, yoga, meditation, and healthy Vietnamese cuisine.',
      city: 'Danang',
      durationDays: 4,
      coverImage: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800',
      isTemplate: true,
      ...
      items: {
        create: [
          ...
          { locationId: locations[0].id, dayNumber: 1, orderIndex: 0, startTime: '16:00', endTime: '18:00', transportMode: 'walk', notes: 'Beach relaxation' },
          { locationId: locations[72].id, dayNumber: 1, orderIndex: 1, startTime: '19:00', endTime: '21:00', transportMode: 'grab_bike', notes: 'Healthy dinner' },
          // Day 2 - Yoga & Spa
          { locationId: locations[68].id, dayNumber: 2, orderIndex: 0, startTime: '06:00', endTime: '07:30', transportMode: 'grab_bike', notes: 'Sunrise yoga on beach' },
          { locationId: locations[69].id, dayNumber: 2, orderIndex: 1, startTime: '09:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Morning spa treatment' },
          { locationId: locations[83].id, dayNumber: 2, orderIndex: 2, startTime: '13:00', endTime: '14:30', transportMode: 'grab_bike', notes: 'Vegetarian lunch' },
          { locationId: locations[66].id, dayNumber: 2, orderIndex: 3, startTime: '15:30', endTime: '18:00', transportMode: 'grab_bike', notes: 'Thai Tai Hot Springs' },
          // Day 3 - Nature & Meditation
          { locationId: locations[95].id, dayNumber: 3, orderIndex: 0, startTime: '06:30', endTime: '08:00', transportMode: 'grab_bike', notes: 'Morning meditation' },
          { locationId: locations[14].id, dayNumber: 3, orderIndex: 1, startTime: '09:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Son Tra nature walk' },
          { locationId: locations[72].id, dayNumber: 3, orderIndex: 2, startTime: '13:00', endTime: '14:30', transportMode: 'grab_bike', notes: 'Healthy lunch' },
          { locationId: locations[94].id, dayNumber: 3, orderIndex: 3, startTime: '16:00', endTime: '18:00', transportMode: 'grab_bike', notes: 'Traditional massage' },
          // Day 4 - Final Relaxation
          { locationId: locations[93].id, dayNumber: 4, orderIndex: 0, startTime: '09:00', endTime: '14:00', transportMode: 'grab_car', notes: 'Fusion Maia spa day' },
          { locationId: locations[0].id, dayNumber: 4, orderIndex: 1, startTime: '16:00', endTime: '18:00', transportMode: 'grab_bike', notes: 'Farewell beach sunset' },
        ],
      },
    },
  });
  ...
  await prisma.itineraryTemplate.create({
    data: {
      name: 'Wellness & Rejuvenation Retreat',
      description: 'A healing journey focused on spa, yoga, meditation, and healthy cuisine.',
      coverImage: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800',
      tagline: 'Restore your body and mind',
      city: 'Danang',
      durationDays: 4,
      targetPersonas: ['wellness', 'relaxer'],
      targetVibes: ['relaxation', 'peaceful', 'healing', 'nature'],
      targetBudget: 'luxury',
      targetInterests: ['spa', 'yoga', 'meditation', 'healthy_food', 'nature'],
      highlights: ['Beach yoga', 'Hot springs', 'Spa treatments', 'Meditation sessions'],
      badges: ['wellness', 'relaxation', 'premium'],
      itineraryId: wellnessRetreatItinerary.id,
      displayOrder: 13,
    },
  });

  // Local Immersion - 4 Days
  const localItinerary = await prisma.itinerary.create({
    data: {
      title: 'Local Life Immersion',
      description: 'Experience Da Nang like a local with hidden gems, neighborhood walks, and authentic interactions.',
      city: 'Danang',
      durationDays: 4,
      coverImage: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=800',
      isTemplate: true,
      ...
      items: {
        create: [
          // Day 1 - Downtown Life
          { locationId: locations[80].id, dayNumber: 1, orderIndex: 0, startTime: '06:30', endTime: '07:30', transportMode: 'walk', notes: 'Local breakfast spot' },
          { locationId: locations[6].id, dayNumber: 1, orderIndex: 1, startTime: '08:00', endTime: '10:30', transportMode: 'walk', notes: 'Han Market morning hustle' },
          { locationId: locations[81].id, dayNumber: 1, orderIndex: 2, startTime: '11:00', endTime: '12:30', transportMode: 'grab_bike', notes: 'Hidden bun cha spot' },
          { locationId: locations[87].id, dayNumber: 1, orderIndex: 3, startTime: '15:00', endTime: '17:00', transportMode: 'grab_bike', notes: 'Local bookstore cafe' },
          { locationId: locations[91].id, dayNumber: 1, orderIndex: 4, startTime: '18:00', endTime: '21:00', transportMode: 'walk', notes: 'Night market dinner' },
          // Day 2 - Neighborhoods
          { locationId: locations[88].id, dayNumber: 2, orderIndex: 0, startTime: '05:30', endTime: '07:00', transportMode: 'grab_bike', notes: 'Sunrise beach coffee' },
          { locationId: locations[82].id, dayNumber: 2, orderIndex: 1, startTime: '08:00', endTime: '09:30', transportMode: 'grab_bike', notes: 'Fresh seafood market' },
          { locationId: locations[85].id, dayNumber: 2, orderIndex: 2, startTime: '10:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Digital nomad cafe' },
          { locationId: locations[5].id, dayNumber: 2, orderIndex: 3, startTime: '14:00', endTime: '16:30', transportMode: 'grab_bike', notes: 'Linh Ung Pagoda' },
          { locationId: locations[10].id, dayNumber: 2, orderIndex: 4, startTime: '18:00', endTime: '20:30', transportMode: 'grab_bike', notes: 'Beachside seafood dinner' },
          // Day 3 - Cultural Deep Dive
          { locationId: locations[89].id, dayNumber: 3, orderIndex: 0, startTime: '07:00', endTime: '08:00', transportMode: 'grab_bike', notes: 'Pagoda morning visit' },
          { locationId: locations[40].id, dayNumber: 3, orderIndex: 1, startTime: '09:00', endTime: '13:00', transportMode: 'grab_bike', notes: 'Cooking class with locals' },
          { locationId: locations[92].id, dayNumber: 3, orderIndex: 2, startTime: '15:00', endTime: '16:30', transportMode: 'grab_bike', notes: 'Local handicrafts' },
          { locationId: locations[47].id, dayNumber: 3, orderIndex: 3, startTime: '18:00', endTime: '21:00', transportMode: 'walk', notes: 'An Thuong walking street' },
          // Day 4 - Countryside
          { locationId: locations[76].id, dayNumber: 4, orderIndex: 0, startTime: '07:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Countryside cycling' },
          { locationId: locations[80].id, dayNumber: 4, orderIndex: 1, startTime: '13:00', endTime: '14:30', transportMode: 'grab_bike', notes: 'Local rice shop lunch' },
          { locationId: locations[96].id, dayNumber: 4, orderIndex: 2, startTime: '16:00', endTime: '18:00', transportMode: 'grab_bike', notes: 'Bamboo forest stroll' },
        ],
      },
    },
  });
  ...
  await prisma.itineraryTemplate.create({
    data: {
      name: 'Local Life Immersion',
      description: 'Experience Da Nang like a local with hidden gems and authentic interactions.',
      coverImage: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=800',
      tagline: 'Live like a local',
      city: 'Danang',
      durationDays: 4,
      targetPersonas: ['culture_seeker', 'authentic'],
      targetVibes: ['local', 'authentic', 'immersive', 'cultural'],
      targetBudget: 'budget',
      targetInterests: ['local_food', 'markets', 'neighborhoods', 'authentic_experiences'],
      highlights: ['Hidden local eateries', 'Morning markets', 'Countryside cycling', 'Cooking with locals'],
      badges: ['local', 'authentic', 'hidden_gems'],
      itineraryId: localItinerary.id,
      displayOrder: 14,
    },
  });

  // Water Sports & Beach - 3 Days
  const beachSportsItinerary = await prisma.itinerary.create({
    data: {
      title: 'Beach & Water Sports Paradise',
      description: 'Sun, sand, and adventure! Surfing, SUP, snorkeling, and beach fun for water lovers.',
      city: 'Danang',
      durationDays: 3,
      coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800',
      isTemplate: true,
      ...
      items: {
        create: [
          // Day 1 - Surfing
          { locationId: locations[0].id, dayNumber: 1, orderIndex: 0, startTime: '06:00', endTime: '07:00', transportMode: 'walk', notes: 'Sunrise swim' },
          { locationId: locations[28].id, dayNumber: 1, orderIndex: 1, startTime: '07:30', endTime: '11:00', transportMode: 'walk', notes: 'Surf lesson' },
          { locationId: locations[10].id, dayNumber: 1, orderIndex: 2, startTime: '12:00', endTime: '13:30', transportMode: 'walk', notes: 'Beach lunch' },
          { locationId: locations[73].id, dayNumber: 1, orderIndex: 3, startTime: '14:30', endTime: '16:00', transportMode: 'grab_bike', notes: 'Parasailing adventure' },
          { locationId: locations[97].id, dayNumber: 1, orderIndex: 4, startTime: '17:00', endTime: '19:00', transportMode: 'grab_bike', notes: 'Beach bar sunset' },
          // Day 2 - Water Adventures
          { locationId: locations[75].id, dayNumber: 2, orderIndex: 0, startTime: '07:00', endTime: '09:00', transportMode: 'grab_bike', notes: 'SUP on Han River' },
          { locationId: locations[31].id, dayNumber: 2, orderIndex: 1, startTime: '09:30', endTime: '10:30', transportMode: 'grab_bike', notes: 'Breakfast fuel' },
          { locationId: locations[77].id, dayNumber: 2, orderIndex: 2, startTime: '11:30', endTime: '16:00', transportMode: 'grab_bike', notes: 'Snorkeling tour' },
          { locationId: locations[79].id, dayNumber: 2, orderIndex: 3, startTime: '17:00', endTime: '19:00', transportMode: 'grab_bike', notes: 'Secret beach chill' },
          // Day 3 - Beach Hopping
          { locationId: locations[79].id, dayNumber: 3, orderIndex: 0, startTime: '06:30', endTime: '09:00', transportMode: 'grab_bike', notes: 'Secret beach sunrise' },
          { locationId: locations[1].id, dayNumber: 3, orderIndex: 1, startTime: '10:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Non Nuoc Beach' },
          { locationId: locations[82].id, dayNumber: 3, orderIndex: 2, startTime: '13:00', endTime: '14:30', transportMode: 'grab_bike', notes: 'Fresh seafood lunch' },
          { locationId: locations[0].id, dayNumber: 3, orderIndex: 3, startTime: '15:30', endTime: '18:00', transportMode: 'grab_bike', notes: 'My Khe farewell swim' },
        ],
      },
    },
  });
  ...
  await prisma.itineraryTemplate.create({
    data: {
      name: 'Beach & Water Sports Paradise',
      description: 'Sun, sand, and adventure! Surfing, SUP, snorkeling, and beach fun.',
      coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800',
      tagline: 'Ride the waves',
      city: 'Danang',
      durationDays: 3,
      targetPersonas: ['adventurer', 'beach_lover'],
      targetVibes: ['adventure', 'beach', 'active', 'fun'],
      targetBudget: 'moderate',
      targetInterests: ['surfing', 'water_sports', 'swimming', 'beach', 'snorkeling'],
      highlights: ['Surf lessons', 'SUP paddling', 'Snorkeling tour', 'Secret beaches'],
      badges: ['adventure', 'beach', 'active'],
      itineraryId: beachSportsItinerary.id,
      displayOrder: 15,
    },
  });

  // Digital Nomad Week - 7 Days
  const nomadItinerary = await prisma.itinerary.create({
    data: {
      title: 'Digital Nomad\'s Week',
      description: 'Balance work and exploration with the best cafes, coworking spots, and after-work adventures.',
      city: 'Danang',
      durationDays: 7,
      ...
      items: {
        create: [
          // Day 1 - Settle In
          { locationId: locations[85].id, dayNumber: 1, orderIndex: 0, startTime: '09:00', endTime: '13:00', transportMode: 'grab_bike', notes: 'Work at coworking cafe' },
          { locationId: locations[8].id, dayNumber: 1, orderIndex: 1, startTime: '13:30', endTime: '14:30', transportMode: 'walk', notes: 'Lunch break' },
          { locationId: locations[85].id, dayNumber: 1, orderIndex: 2, startTime: '15:00', endTime: '18:00', transportMode: 'walk', notes: 'Afternoon work' },
          { locationId: locations[0].id, dayNumber: 1, orderIndex: 3, startTime: '18:30', endTime: '20:00', transportMode: 'grab_bike', notes: 'Sunset beach walk' },
          // Day 2 - Beach Morning
          { locationId: locations[0].id, dayNumber: 2, orderIndex: 0, startTime: '06:00', endTime: '08:00', transportMode: 'walk', notes: 'Morning swim' },
          { locationId: locations[21].id, dayNumber: 2, orderIndex: 1, startTime: '09:00', endTime: '12:30', transportMode: 'grab_bike', notes: 'Work at specialty cafe' },
          { locationId: locations[18].id, dayNumber: 2, orderIndex: 2, startTime: '13:00', endTime: '14:00', transportMode: 'walk', notes: 'Local noodle lunch' },
          { locationId: locations[21].id, dayNumber: 2, orderIndex: 3, startTime: '14:30', endTime: '18:00', transportMode: 'walk', notes: 'Afternoon focus' },
          { locationId: locations[65].id, dayNumber: 2, orderIndex: 4, startTime: '19:30', endTime: '22:00', transportMode: 'grab_bike', notes: 'Expat pub networking' },
          // Day 3 - Culture Day
          { locationId: locations[3].id, dayNumber: 3, orderIndex: 0, startTime: '07:00', endTime: '11:00', transportMode: 'grab_bike', notes: 'Marble Mountains explore' },
          { locationId: locations[87].id, dayNumber: 3, orderIndex: 1, startTime: '12:00', endTime: '17:00', transportMode: 'grab_bike', notes: 'Work at bookstore cafe' },
          { locationId: locations[2].id, dayNumber: 3, orderIndex: 2, startTime: '21:00', endTime: '22:00', transportMode: 'grab_bike', notes: 'Dragon Bridge show' },
          // Day 4 - Productivity Day
          { locationId: locations[85].id, dayNumber: 4, orderIndex: 0, startTime: '08:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Morning deep work' },
          { locationId: locations[31].id, dayNumber: 4, orderIndex: 1, startTime: '12:30', endTime: '13:30', transportMode: 'grab_bike', notes: 'Pho lunch' },
          { locationId: locations[86].id, dayNumber: 4, orderIndex: 2, startTime: '14:00', endTime: '18:00', transportMode: 'grab_bike', notes: 'Afternoon at Cong Cafe' },
          { locationId: locations[47].id, dayNumber: 4, orderIndex: 3, startTime: '19:00', endTime: '22:00', transportMode: 'grab_bike', notes: 'Walking street dinner' },
          // Day 5 - Adventure Break
          { locationId: locations[75].id, dayNumber: 5, orderIndex: 0, startTime: '06:30', endTime: '08:30', transportMode: 'grab_bike', notes: 'SUP session' },
          { locationId: locations[21].id, dayNumber: 5, orderIndex: 1, startTime: '09:30', endTime: '13:00', transportMode: 'grab_bike', notes: 'Work session' },
          { locationId: locations[14].id, dayNumber: 5, orderIndex: 2, startTime: '14:00', endTime: '18:00', transportMode: 'grab_bike', notes: 'Son Tra afternoon explore' },
          // Day 6 - Day Trip
          { locationId: locations[42].id, dayNumber: 6, orderIndex: 0, startTime: '08:00', endTime: '18:00', transportMode: 'grab_car', notes: 'Hoi An day trip' },
          { locationId: locations[10].id, dayNumber: 6, orderIndex: 1, startTime: '19:30', endTime: '21:00', transportMode: 'grab_bike', notes: 'Beach dinner' },
          // Day 7 - Farewell
          { locationId: locations[88].id, dayNumber: 7, orderIndex: 0, startTime: '05:30', endTime: '07:00', transportMode: 'grab_bike', notes: 'Sunrise coffee' },
          { locationId: locations[85].id, dayNumber: 7, orderIndex: 1, startTime: '08:00', endTime: '12:00', transportMode: 'grab_bike', notes: 'Final work session' },
          { locationId: locations[12].id, dayNumber: 7, orderIndex: 2, startTime: '17:00', endTime: '20:00', transportMode: 'grab_bike', notes: 'Sky36 farewell' },
        ],
      },
    },
  });
  ...
  await prisma.itineraryTemplate.create({
    data: {
      name: 'Digital Nomad\'s Week',
      description: 'Balance work and exploration with the best cafes and after-work adventures.',
      coverImage: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=800',
      tagline: 'Work hard, explore harder',
      city: 'Danang',
      durationDays: 7,
      targetPersonas: ['digital_nomad', 'remote_worker'],
      targetVibes: ['productive', 'balanced', 'social', 'flexible'],
      targetBudget: 'moderate',
      targetInterests: ['wifi_cafes', 'coworking', 'networking', 'work_life_balance'],
      highlights: ['Best wifi cafes', 'Coworking spots', 'Expat networking', 'Work-adventure balance'],
      badges: ['digital_nomad', 'wifi', 'flexible'],
      itineraryId: nomadItinerary.id,
      displayOrder: 16,
    },
  });

  console.log('✅ Created 16 itinerary templates');
  ...
  console.log(`   • ${locations.length} locations across Da Nang (expanded for search testing)`);
  console.log('   • 16 itinerary templates (various themes & durations)');
